...
- 오늘 할 일
  ...
  - 서버 성능 개선 관련 최적화 작업 완료
  - 발표준비
  - 멘토님과 수다!
- 소감

  - 오늘은 성능 개선 이후 남은 시간동안 그동안 했던 부분들을 정리하고 발표준비를 진행했다. 
  - 지금까지 했던 자료들을 정리하는 과정 중에서 정말 많은 생각들을 하게 되었다. 
  - 부족했던 부분, 기분이 좋았던 부분, 실망했던 부분, 만족했던 부분 등 다양한 경험들을 다시 한번 생각해보는 시간을 가질 수 있었다. 
  - 아직 남은시간이 짧은 시간일수도 있지만 마지막까지 이 시간을 잘 활용해서 인턴 이후에도 도움이 되었던 시간으로 기억이 될 수 있도록 끝까지 최선을 다할 것이다.
  - 또한 그동안 일일보고를 통해 스스로 약속하고 다짐했던 부분도 잊지 않고 실천하며 잘 마무리 하고 싶다.
  - 그래서 오늘도 밤샘.. 발표준비를 위해..
